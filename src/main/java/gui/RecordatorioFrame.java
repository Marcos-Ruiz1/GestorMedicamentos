...
public class RecordatorioFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Lucida Sans Unicode", 2, 10)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("<html>Al elegir una de las opciones saltará una notificación retitivamente dependiendo <br>el medicamento seleccionado de la tabla</html>");
        ...
        btnDiario.setBackground(new java.awt.Color(0, 0, 255));
        btnDiario.setFont(new java.awt.Font("Lucida Sans Unicode", 1, 14)); // NOI18N
        ...
        jPanel1.add(btnDiario, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, -1, -1));

        btnSemanal.setBackground(new java.awt.Color(0, 0, 255));
        btnSemanal.setFont(new java.awt.Font("Lucida Sans Unicode", 1, 14)); // NOI18N
        ...
        jPanel1.add(btnSemanal, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordatorioFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordatorioFrame().setVisible(true);
            }
        });
    }
